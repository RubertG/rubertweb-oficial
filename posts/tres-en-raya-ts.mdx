...
Varias funcionalidades interesantes quedaron por explicar, puedes ver su implementación en el repositorio del proyecto en <a href="https://github.com/RubertG/tres-en-raya-ts" target="_blank">GitHub</a>, tambien puedes ver el juego dando <a href="https://tres-en-raya-ts.netlify.app/" target="_blank">click aquí</a>.